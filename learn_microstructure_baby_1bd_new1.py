...
class build_stiffness_matrix(nn.Module):
    def __init__(self, matrix_dict, X, E):
        ...
        #self.fc2=nn.Linear(100,200,bias=True)
        #self.fc3=nn.Linear(200,1,bias=True)
...
save_base_dir="80test_nonn/test/"
...
model = build_stiffness_matrix(matrix_dict,X, E_ini)
...
#model_filename_restart = './80test_fc1-2-100_fc2-100-200_fc3-200-1_lr2e-4_gamma050_nsamples1000/nnParameters.ckpt'
